...
class Game(commands.Cog):
    ...
    async def setup_clues(self, ctx: commands.Context):
    ...
    async def char_sheet(self, ctx: commands.Context):
    ...
    async def clue_check(self, ctx: commands.Context):
    ...
    async def ten_min_card(
        self, ctx: commands.Context, mention: typing.Union[discord.Member, discord.Role]
    ):
